            ...
            <div id="toolbarSidebarRight">
                <div id="outlineOptionsContainer">
                    ...
                    <button id="currentOutlineItem" class="toolbarButton" disabled="disabled"
                        title="Find Current Outline Item" tabindex="6" data-l10n-id="pdfjs-current-outline-item-button">
        ...
        <div class="findbar hidden doorHanger" id="findbar">
            ...
            <div id="findbarOptionsOneContainer">
                ...
                <label for="findHighlightAll" class="toolbarLabel"
                    data-l10n-id="pdfjs-find-highlight-checkbox">Highlight
                    All</label>
            ...
            <div id="secondaryToolbarButtonContainer">
                ...
                <div id="scrollModeButtons" role="radiogroup">
                    ...
                    <button id="scrollHorizontal" class="secondaryToolbarButton" title="Use Horizontal Scrolling"
                        tabindex="64" data-l10n-id="pdfjs-scroll-horizontal-button" role="radio" aria-checked="false">
                ...
                <div id="toolbarViewer">
                    <div id="toolbarViewerLeft">
                        ...
                        <span class="loadingInput start">
                            <input type="number" id="pageNumber" class="toolbarField" title="Page" value="1" min="1"
                                tabindex="15" data-l10n-id="pdfjs-page-input" autocomplete="off">
                        </span>
                    ...
                    <div id="toolbarViewerRight">
                        <div id="editorModeButtons" class="splitToolbarButton toggled" role="radiogroup">
                            ...
                            <button id="presentationMode" class="secondaryToolbarButton" title="Switch to Full Screen"
                                tabindex="35" data-l10n-id="pdfjs-presentation-mode-button">
                                <span data-l10n-id="pdfjs-presentation-mode-button-label">Fullscreen</span>
                            </button>
                            <div style="display: none;" class="">
                                <button id="editorHighlight" class="toolbarButton" hidden="true" disabled="disabled"
                                ...
                                <button id="editorStamp" class="toolbarButton hidden" disabled="disabled"
                                    ...
                                    aria-controls="editorStampParamsToolbar" tabindex="35"
                        ...
                        <div style="display: none;" class="">
                            <button id="print" hidden=true class="toolbarButton hiddenMediumView" title="Print"
